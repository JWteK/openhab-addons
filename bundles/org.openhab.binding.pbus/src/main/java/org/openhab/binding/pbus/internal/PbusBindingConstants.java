...
public class PbusBindingConstants {
    ...
    public static final ThingTypeUID THING_2Y10S = new ThingTypeUID(BINDING_ID, "2y10s");
    ...
    public static final Set<ThingTypeUID> SUPPORTED_THING_UIDS = Set.of(THING_2C, THING_2D20, THING_2R1K, THING_2Y10S,
    ...
    public static final byte MODULE_2Y10S = 0x03;
    ...
    public static final byte SENSOR_STATUS_REQUEST = (byte) 0x12;
    public static final byte SENSOR_STATUS_ANSWER = (byte) 0x22;

    public static final byte COUNTER_STATUS_REQUEST = (byte) 0x13;
    public static final byte COUNTER_STATUS_ANSWER = (byte) 0x23;

    public static final byte HAND_STATUS_REQUEST = (byte) 0x14;
    public static final byte HAND_STATUS_ANSWER = (byte) 0x24;

    public static final byte SWITCH_RELAY = (byte) 0x31;

    public static final byte SET_VALUE = (byte) 0x41;

    public static final byte ALL_CHANNELS = (byte) 0x00;
}
