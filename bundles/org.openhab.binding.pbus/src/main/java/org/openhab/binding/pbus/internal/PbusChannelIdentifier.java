...
/**
 * The {@link PbusChannelIdentifier} represents a class with properties that uniquely identify a channel.
 *
 * @author JWteK - Initial contribution
 */
@NonNullByDefault
public class PbusChannelIdentifier {

    private byte address;
    private byte channel;

    public PbusChannelIdentifier(byte address, byte channel) {
